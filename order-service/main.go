...
import (
	...
	"OnlineStore/order-service/repository"
	"OnlineStore/order-service/routes"
	"context"
...
func main() {
	...
	productModel := repository.NewOrderRepository(database)
	productController := controllers.NewOrderController(productModel)
